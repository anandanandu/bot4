...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:DARK BOT\n'
            + 'ORG:Owner Gans;\n'
            + 'TEL;type=CELL;type=VOICE;waid=+919061363103:+91 906-136-3103\n'
            + 'END:VCARD'

prefix = "#"
name = "~ DARK MALLU BOT by @doc"
rdaftar = "YOU ARE REGISTERED😁"
rmenu = "HALLO THERE😊"
botinfo = "MADE by @doc_.editor_mmx:)"
limitt = 9999999999
memberLimit = 2
ban = ["+919061363103@s.whatsapp.net"]
premium = ["+919061363103@s.whatsapp.net"]
...
async function starts() {
	...
	dms.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["+919061363103@s.whatsapp.net"] // owner number ubah aja
		...
		case prefix+'daftar':
         ...
         case prefix+'lirik':
                ...
                //if (!isPublic) return reply(mess.only.publikG)
                    ...
                    dms.sendMessage('+919061363103@s.whatsapp.net', options, text, {quoted: mek})
